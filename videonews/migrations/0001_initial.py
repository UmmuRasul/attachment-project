    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.CharField(choices=[('Health', 'health'), ('Skills', 'skills'), ('Sports', 'sports'), ('Politics', 'politics'), ('Social', 'social'), ('Motivateion', 'motivation'), ('Business', 'business')], default='Education', max_length=40)),
